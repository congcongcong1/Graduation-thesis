...
DEVICE_CRITIC = torch.device("cuda:1") if torch.cuda.device_count() > 1 else DEVICE_ACTOR
CONFIG = {
  ...
  # 核心修改：将奖励权重提高
    ...
    "ffmpeg_bin": "ffmpeg",
    "work_dir": "/workspace/RL/ElegantRL-master/my_RL/rl_nvenc_tmp",
    ...
    "log_dir": "/workspace/RL/ElegantRL-master/my_RL/runs/rapnet_hevc_1_30_v44",
    "model_dir": "/workspace/RL/ElegantRL-master/my_RL/checkpoints/rapnet_hevc_1_30_v44",
...
def debug_once():
    ...
    env = NvencClipEnvQP(
        ...
        rd_curve_json="/workspace/RL/ElegantRL-master/my_RL/result/rd_baseline_hevc_qp_full_clip_lowbits_alex.json",
        work_dir=CONFIG["work_dir"],
        qp_list=CONFIG["qp_list"],
        clip_len=clip_len,
        fps=CONFIG["fps"],
...
if __name__ == "__main__":
    ...
    # )
    for metric in ["lpips","vmaf", "dists", "wasserstein"]:  # Skip lpips if already tested
        CONFIG["quality_metric"] = metric
        CONFIG["num_iterations"] = 1000
        CONFIG["log_dir"] = f"/workspace/RL/ElegantRL-master/my_RL/runs/rapnet_hevc_2_9_v46_test_{metric}"
        CONFIG["model_dir"] = f"/workspace/RL/ElegantRL-master/my_RL/checkpoints/rapnet_hevc_2_9_v46_test_{metric}"
        train_rapnet_with_config(
        video_meta_list=video_meta_list,
        rd_json_path=f"/workspace/RL/ElegantRL-master/my_RL/result/rd_baseline_crop30_{metric}.json",  # 使用新baseline
        )
    pass
