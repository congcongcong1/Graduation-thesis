\begin{tikzpicture}[
    ...
    updown/.style={rectangle, rounded corners=1pt, draw=black, fill=teal!15, minimum width=0.6cm, minimum height=1.0cm, align=center, inner sep=2pt, font=\scriptsize},
    ...
    % --- Colors (colorized for academic style) ---
    f_pups/.style={fill=magenta!10},
    f_conv/.style={fill=blue!12},
    f_lrelu/.style={fill=green!12},
    f_res/.style={fill=orange!15},
    f_pool/.style={fill=cyan!15},
    f_linear/.style={fill=purple!15},
    f_flatten/.style={fill=yellow!15}
]
